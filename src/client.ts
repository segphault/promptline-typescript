...
export interface ClientOptions {
  /**
   * Defaults to process.env['PROMPTLINE_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['PROMPTLINE_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['PROMPTLINE_LOG'] or 'warn' if it isn't set.
   */
...
export class Promptline {
   ...
   * @param {string} [opts.baseURL=process.env['PROMPTLINE_BASE_URL'] ?? http://promptline.drydock.fleet/] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('PROMPTLINE_BASE_URL'),
    apiKey = readEnv('PROMPTLINE_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `http://promptline.drydock.fleet/`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? Promptline.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('PROMPTLINE_LOG'), "process.env['PROMPTLINE_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'http://promptline.drydock.fleet/';
  }
  ...
  protected stringifyQuery(query: Record<string, unknown>): string {
    return Object.entries(query)
      ...
      .map(([key, value]) => {
        ...
        throw new Errors.PromptlineError(
  ...
  static Promptline = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static PromptlineError = Errors.PromptlineError;
...
export declare namespace Promptline {
  ...
  export {
    PersonaResource as PersonaResource,
